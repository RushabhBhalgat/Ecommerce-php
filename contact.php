            ...
            <div class="col-md-9">
                <div class="box">
                    <div class="box-header">
                        <center>
                            <h2>Contact Us</h2>
                            <p class="text-muted">If have any queries / doubts / questions for us.... feel free to ask
                                the questions by filling up the below given form</p>
                        </center>
                    </div>
                    <form action="contactus.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" class="form-control" required id="">
                        </div>
                        <div class="form-group">
                            <label for="">Message</label>
                            <textarea required name="message" class="form-control" id="" cols="30" rows="10"></textarea>
                        </div>
