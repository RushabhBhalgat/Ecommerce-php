    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-sm-6 single">
        ...
        <div class="product">
          ...
          <a href="details.php">
            <img class="img-responsive" src="admin_area/product_images/Allen Solly Men's Slim fit Casual Shirt/1.jpeg"
              alt="">
          </a>
          <div class="text">
      ...
      <div class="col-sm-4 col-sm-6 single">
        ...
        <div class="product">
          <!-- product div starts here -->
          <a href="details.php">
            <img class="img-responsive" src="admin_area/product_images/Allen Solly Men's Slim fit Casual Shirt/3.jpeg"
              alt="">
          </a>
          <div class="text">
            <h3><a href="details.php">Allen Solly Men's Slim fit Casual Shirt</a></h3>
